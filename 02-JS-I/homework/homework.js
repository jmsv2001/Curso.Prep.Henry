// Respuestas a homework de 02-JS-I por jmsv2001
...
function elevarAlCuadrado(num) {
  ...
  // Tu código:
    var cuadrado = num * num;   // var cuadrado = Math.pow(num,2);
    return cuadrado;
}
...
function elevarAlCubo(num) {
  // Devuelve el valor de "num" elevado al cubo
    // Tu código:
    var cubo = num * num * num; // var cubo = Math.pow(num,3);
    return cubo;
}
